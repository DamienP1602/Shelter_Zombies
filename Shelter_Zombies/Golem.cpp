...
void Golem::Init()
{
	...
	AnimationData("Idle", Vector2f(2.0, 2.0f), Vector2f(17.0, 32.0f), READ_RIGHT, true, 1, _speed),
	AnimationData("Movement", Vector2f(33.0f, 3.0f), Vector2f(26.0, 32.0f), READ_RIGHT, true, 4, _speed),
