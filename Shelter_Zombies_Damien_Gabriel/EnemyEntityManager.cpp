...
{
	const Vector2f& _origin = _isAttack ? Vector2f(1900.0f, 0.0f) : Vector2f(800.0f, 0.0f);

	int _size = int(allFighters.size());
	for (int i = 0; i < _size; i++)
	{
		const Vector2f& _position = _origin + Vector2f(0, 1080.f / _size * (i + 1.f)); //Column
	...
	for (int i = 0; i < _size; i++)
	{
		const Vector2f& _position = _origin + Vector2f(100.f, 1080.f / _size * (i + 1.f));
	...
	for (int i = 0; i < _size; i++)
	{
		const Vector2f& _position = _origin + Vector2f(200.f, 1080.f / _size * (i + 1.f));
	...
	for (int i = 0; i < _size; i++)
	{
		const Vector2f& _position = _origin + Vector2f(300.f, 1080.f / _size * (i + 1.f));
