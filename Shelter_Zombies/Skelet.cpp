...
#define ENTITY_SHAPE_FIGHTER_SIZE Vector2f(750.f,750.f)

Skelet::Skelet(const Vector2f& _position, const int _level) :
	Entity("Skelet", false, ShapeData(_position, ENTITY_SHAPE_FIGHTER_SIZE, ENTITY_SHAPE_FIGHTER_PATH, IntRect(0, 0, 43, 37)))
{
